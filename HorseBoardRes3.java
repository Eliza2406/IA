...
public class HorseBoardRes3 {
   ...
   public HorseBoardRes3(String breed, String name, String owner, int idNum, int age, double weight, String checkIn,
         String checkOut) {
      this.breed = breed;
      this.name = name;
      this.owner = owner;
   ...
   public String fileState() {
      ...
      // charge;
      /*
       * im not sure what you want to do with charge and dur stay because it wasn't in
       * your constructer
